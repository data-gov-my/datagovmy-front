...
import { default as ChartHeader, ChartHeaderProps } from "src/components/Chart/ChartHeader";
import {
  Chart as ChartJS,
  CategoryScale,
  LineElement,
...
import { maxBy, minBy, numFormat, standardDeviation } from "src/lib/helpers";
// import RegressionPlugin from "./regression-line";
import { ChartCrosshairOption } from "src/lib/types";
import { AKSARA_COLOR } from "src/lib/constants";
...
export interface ScatterProps extends ChartHeaderProps {
  className?: string;
  data?: ScatterData[];
  unitX?: string;
  unitY?: string;
