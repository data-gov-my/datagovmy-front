import { ChartHeaderProps, default as ChartHeader } from "src/components/Chart/ChartHeader";
...
import { clx, numFormat } from "src/lib/helpers";
import type { ChartCrosshairOption, Geotype } from "src/lib/types";
  ...
  useEffect(() => {
    const fetchMaps = async () => {
      const [desktop, mobile] = await Promise.all([
        import(`datagovmy-ui/src/lib/geojson/${type}/_desktop`),
        import(`datagovmy-ui/src/lib/geojson/${type}/_mobile`),
      ]);
