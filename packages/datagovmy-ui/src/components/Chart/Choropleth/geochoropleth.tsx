import { Color, useColor } from "src/hooks/useColor";
import { MapControl, MapControlRef } from "src/hooks/useMap";
import { minMax, numFormat } from "src/lib/helpers";
...
import type { Geotype } from "src/lib/types";
...
const GeoChoropleth: FunctionComponent<GeoChoroplethProps> = ({
  ...
  useEffect(() => {
    import(`datagovmy-ui/src/lib/geojson/${type}/_map`).then(item => {
