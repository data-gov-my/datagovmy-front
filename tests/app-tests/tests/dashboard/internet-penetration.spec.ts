...
const parameters: HeroParameters = {
  _agency: "Malaysian Communications and Multimedia Commission",
  _category: "Digitalisation",
};
const ID = enumify([
...
test.skip("internet-penetration", async ({ page }) => {
  const board = new DashboardPage(page, "internet-penetration");
  await board.goto();
