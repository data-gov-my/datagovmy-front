              ...
              <>
                <div className="relative w-full py-4">
                  <div className="group relative h-2 w-full">
                    ...
                    {/* Thumb Left */}
                    <span
                      className="absolute left-0 -top-1.5 h-5 w-5 cursor-pointer rounded-full border border-dim bg-white shadow-xl transition-all group-hover:ring-4 group-hover:ring-primary"
                      style={{ left: position?.thumb.left }}
                    />

                    {/* Thumb Right */}
                    <span
                      className="absolute -top-1.5 -ml-2 h-5 w-5 cursor-pointer rounded-full border border-dim bg-white shadow-xl transition-all  group-hover:ring-4 group-hover:ring-primary"
