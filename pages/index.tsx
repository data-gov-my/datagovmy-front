...
const Home: Page = ({
  ...
  return (
    <>
      ...
      <Hero background="bg-gradient-radial dark:bg-dark-gradient-radial border-b dark:border-zinc-800 from-white to-primary/10 dark:from-outlineHover-dark dark:to-black">
