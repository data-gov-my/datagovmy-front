              ...
              <>
                <div className="relative w-full py-4">
                  <div className="relative h-2 w-full">
                    <div className="absolute left-0 top-0 h-2 w-full rounded-xl bg-[#E2E8F0]"></div>
                    {/* Active Range */}
                    <div
                      className="absolute left-0 right-0 top-0 h-2 rounded-xl bg-outlineHover"
                      style={{
                    ...
                    {/* Thumb Left */}
                    <span
                      className=" absolute -top-1 left-0 h-4 w-4 cursor-pointer rounded-full border bg-white shadow-xl"
