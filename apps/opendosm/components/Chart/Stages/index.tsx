  ...
  return (
    <div>
      ...
      <div className={className}>
        {/* Header */}
        {data?.header && (
          <div className="m-auto w-fit min-w-[200px] rounded bg-washed px-3 py-1.5 text-center">
  ...
  return (
    <>
      ...
      <div className={`relative ${className}`}>
        ...
        <div className="absolute left-0 top-0 h-2 w-1 rounded-xl bg-outline lg:h-1 lg:w-2" />
        <div className="absolute bottom-0 right-0 top-0 h-2 w-1 bg-outline lg:left-0 lg:top-full lg:h-1 lg:w-2" />
      </div>
