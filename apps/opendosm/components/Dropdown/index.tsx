      ...
      >
        <div className={`relative text-sm ${disabled ? "cursor-not-allowed" : ""}`}>
          ...
          >
            ...
            >
              {/* DESCRIPTION */}
              {description && <p className="px-4 py-1 text-xs text-dim">{description}</p>}
              {/* OPTIONS */}
              ...
              {multiple && (
                <button
                  onClick={() => onChange([])}
                  className="group relative flex w-full cursor-default select-none items-center gap-2 py-2 pl-10 pr-4 text-dim hover:bg-washed disabled:cursor-not-allowed disabled:opacity-50"
