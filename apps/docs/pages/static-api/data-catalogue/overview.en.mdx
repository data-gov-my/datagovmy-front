...
```http
GET https://datagovmy.app/catalogue
```
...
### TODO: How do I know what resources are available?

<b>
TODO: maybe we should provide searchable columns in a new section here (reference: [openfda](https://open.fda.gov/apis/drug/event/searchable-fields/))

TODO: referring to opendosm, full fields may not be available in Data Catalogue page, perhaps we should add them there (along with clearer `id`)

</b>

To determine the available resources and their corresponding IDs and fields, you can refer to the Data Catalogue page. The Data Catalogue page provides a comprehensive list of all the resources available in the catalogue, along with their associated IDs and fields.
...
**TODO: suggested to use a changelog?**
