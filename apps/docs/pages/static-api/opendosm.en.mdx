...
To discover the available resources, visit the [OpenDOSM Data Catalogue page](https://open.dosm.gov.my/data-catalogue).
...
Go to the Data Catalogue page and find the [Core CPI Overall dataset](https://open.dosm.gov.my/data-catalogue/cpi_cpi_core_1).
