...
### GTFS Realtime API Update

- Updated [GTFS Realtime API](realtime-api/gtfs-realtime) with new endpoint for BAS.MY services in Melaka

## 1.5.0 (2025-10-10)

### GTFS Realtime API Update

- Updated [GTFS Realtime API](realtime-api/gtfs-realtime) with new endpoints for BAS.MY services in 5 cities (Kangar, Alor Setar, Kota Bharu, Kuala Terengganu, Kuching)

## 1.4.0 (2024-04-01)

### GTFS Realtime API Update

- Updated [GTFS Realtime API](realtime-api/gtfs-realtime) with new endpoint for MRT Feeder Bus services

## 1.3.0 (2023-11-14)

### GTFS Realtime API Release

- Launched [GTFS Realtime API](realtime-api/gtfs-realtime) with data from myBAS Johor Bahru, KTMB and Prasarana with the following endpoints:
  - `gtfs-realtime/vehicle-position/mybas-johor` for downloading myBAS GTFS-R `.proto` file.
  - `gtfs-realtime/vehicle-position/ktmb` for downloading KTMB GTFS-R `.proto` file.
  - `gtfs-realtime/vehicle-position/prasarana?category=<category>` for downloading Prasarana GTFS-R `.proto` file.
