...
- Nota: Segelintir kecil perjalanan (~2%, diperincikan sepenuhnya dalam [CSV ini](https://openapi-malaysia-transport.s3.ap-southeast-1.amazonaws.com/prasarana/problematic_trips.cs)) bagi endpo
