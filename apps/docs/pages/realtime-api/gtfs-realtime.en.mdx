...
_Note: Validation errors specific to each feed are provided in the [Vehicle Position](#vehicle-position) section below. These errors are generated during the development phase using the [GTFS Realtime Validator](https://github.com/MobilityData/gtfs-realtime-validator)._
