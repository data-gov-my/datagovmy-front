...
At present, our GTFS Realtime API only offers vehicle position data - service alerts and and trip updates are in our pipeline for 2026. For more details on GTFS Realtime and its broader functionalities, please refer to https://gtfs.org/realtime/.
...
- [**BAS.MY**](https://bas.my/): Stage bus services across Malaysia, run by various operators. Endpoints for Johor Bahru, Kangar, Alor Setar, Kuala Terengganu, Kota Bharu, and Kuching are currently available. We plan to expand the feed to cover Melaka, Seremban, and Ipoh by 15 November 2025.
