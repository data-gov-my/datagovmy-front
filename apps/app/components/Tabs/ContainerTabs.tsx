        ...
        <div className="flex h-fit flex-grow flex-nowrap sm:h-[56px]">
          {options.map(({ name, icon, url }, index) => (
            <li
              key={index}
              className={clx(
                "group flex w-fit select-none flex-col items-center justify-center px-3 py-1 text-center text-sm outline-none transition-colors sm:w-auto sm:flex-row md:px-4",
                current === index
